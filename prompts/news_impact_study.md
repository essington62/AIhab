# News Impact Study — BTC 2026

Gerado: 2026-04-25 12:41 UTC

## Dados
- macro_news: 150 artigos totais, 134 na janela BTC
- Classificados (ds_score): 20
- btc_1h: 5675 candles
- Artigos após ex-ante filter: 62
- Baseline ret_4h: -0.0183%
- Baseline ret_24h: -0.1134%

## Tabela de Calibração

| macro | evento | N | ex_ante% | DS_score | edge_4h | edge_24h | acurácia | satura | horizonte_pico |
|---|---|---|---|---|---|---|---|---|---|
| FED | FOMC_DOVISH | 4 | 44% | +7.00 | -0.78% | +1.46% | 0% | N<5 | 24h |
| FED | FOMC_HAWKISH | 4 | 29% | -5.00 | -0.78% | +1.78% | 100% | N<5 | 24h |
| GEO | HORMUZ_BLOCK | 1 | 33% | N/A | -0.76% | -2.57% | N/A | N<5 | 24h |
| GEO | WAR_ESCALATION | 1 | 100% | N/A | -0.61% | -0.71% | N/A | N<5 | 12h |
| LIQUIDITY | STABLECOIN | 1 | 100% | N/A | -0.35% | +5.05% | N/A | N<5 | 24h |
| FED | FOMC_NEUTRAL | 13 | 50% | -1.00 | +0.20% | +0.54% | 0% | não | 12h |
| RISK | RECESSION | 9 | 50% | N/A | -0.11% | +0.77% | N/A | sim | 24h |
| GEO | WAR_DEESCALATION | 4 | 44% | +4.00 | +0.10% | +0.64% | 0% | N<5 | 24h |
| ENERGY | OIL_PRICE | 7 | 47% | N/A | -0.07% | +1.68% | N/A | sim | 24h |
| OTHER | UNCATEGORIZED | 18 | 47% | -3.00 | +0.04% | -0.80% | 50% | sim | 24h |

## Tabela de Saturação

| Cluster | N | edge_1st | edge_2nd | edge_3rd+ | Satura? |
|---|---|---|---|---|---|
| ENERGY/OIL_PRICE | 7 | +0.56% | -0.27% | -0.15% | ✅ sim |
| FED/FOMC_NEUTRAL | 13 | -0.13% | -0.35% | +0.28% | ❌ não |
| OTHER/UNCATEGORIZED | 18 | +0.34% | -0.36% | +0.04% | ✅ sim |
| RISK/RECESSION | 9 | +0.65% | -0.93% | -0.11% | ✅ sim |
